...
This checkout contains TTD deployment and runtime behavior for the Xique API,
public Gradio route, shared model caches, and generated audio download names:

- [`docs/operations/ttd-runtime-notes.md`](docs/operations/ttd-runtime-notes.md)
